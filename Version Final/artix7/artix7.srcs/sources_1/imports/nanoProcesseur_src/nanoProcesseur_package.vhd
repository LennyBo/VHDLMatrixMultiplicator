...
package nanoProcesseur_package is
 ...
 -- Adresses de bases des IP
  ...
  constant BASEADDR_IP4  : std_logic_vector(ADDR_BUS_WIDTH-1 downto 0) := X"80";
  constant BASEADDR_PORT : std_logic_vector(ADDR_BUS_WIDTH-1 downto 0) := X"90";
  constant BASEADDR_POUSSOIR : std_logic_vector(ADDR_BUS_WIDTH-1 downto 0) := X"A0"; 
